...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'admin', description: 'Уникальное название роли / Unique role name' }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], Role.prototype, "value", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Administration role', description: 'Описание роли / Role description' }),
